...
public class BaseActivity extends AppCompatActivity
    ...
    private void initLayout(Bundle savedInstanceState) {
        ...
        View createActionFragment = findViewById(R.id.change_city_frame);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isPortrait) {
                    addFragment(R.id.content_frame, CreateActionFragment.newInstance());
                }
            }
        });

        if (savedInstanceState == null) {
            startWeatherFragment("Иркутск");
        }
        if (!isPortrait) {
            startCityFragment();
        }
    ...
    private void addFragment(int frameLayout, Fragment fragment) {
    ...
    public void startWeatherFragment(String country) {
        addFragment(R.id.content_frame, WeatherFragment.newInstance(country));
    }

    public void startCityFragment() {
        addFragment(R.id.change_city_frame, CreateActionFragment.newInstance());
    }
