...
import com.geekbrains.weather.ui.weather.AddWeatherItemFragment;
...
public class BaseActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            addFragment(new WeatherFragment());
        } else if (getCurrentFragment() instanceof AddWeatherItemFragment) {
            addFragment(new WeatherFragment());
        } else {
            super.onBackPressed();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_weather_item) {
            addFragment(new AddWeatherItemFragment());
