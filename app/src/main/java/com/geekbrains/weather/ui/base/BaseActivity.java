...
public class BaseActivity extends AppCompatActivity
    ...
    public final static String  SENSOR_TEMPERATURE = "SENSOR_TEMPERATURE";
    public final static String  SENSOR_HUMIDITY = "SENSOR_HUMIDITY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                String humidity = String.valueOf(intent.getFloatExtra(SENSOR_HUMIDITY, 0));
                String temperature = String.valueOf(intent.getFloatExtra(SENSOR_TEMPERATURE, 0));
                Log.d(SENSOR_HUMIDITY, humidity);
                Log.d(SENSOR_TEMPERATURE, temperature);
                showHumiditySensor(humidity);
                showTemperatureSensor(temperature);
            }
        };
    ...
    private void initLayout() {
        ...
        tv_temperature = findViewById(R.id.bigTemp);
    ...
    private void showHumiditySensor(String value) {
    ...
    private void showTemperatureSensor(String value) {
        if (tv_temperature == null) {
            tv_temperature = findViewById(R.id.bigTemp);
        }
        StringBuilder stringBuilder = new StringBuilder();
        if (Float.parseFloat(value) >= 0)
            stringBuilder.append("+").append(Math.round(Float.parseFloat(value)));
        else
            stringBuilder.append("-").append(Math.round(Float.parseFloat(value)));
