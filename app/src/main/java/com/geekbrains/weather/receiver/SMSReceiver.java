...
/**
 * Created by shkryaba on 08/08/2018.
 */
...
public class SMSReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null && intent.getAction() != null) {
            ...
            sendBroadcastSms(context, bodyText);
        }
    }

    private void sendBroadcastSms(Context context, String code) {
        Intent smsIntent = new Intent("SMS_INTENT");
        smsIntent.putExtra("SMS_CODE", code);
